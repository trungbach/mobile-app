...
export const addCartAction = createAsyncThunk("cart/add", async (data, { rejectWithValue }) => {
  try {
...
export const deleteCartAction = createAsyncThunk("cart/delete", async (id, { rejectWithValue }) => {
  try {
